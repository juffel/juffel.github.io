...
start.addOption("begin", ["begin", "start"], "begin");
start.addOption("credits", ["credits", "credits"], "credits");

var credits = new Scene("credits", ["CREDITS"]);
credits.setDescription("+++ juffel +++");
credits.addOption("begin", ["begin", "start"], "begin");
...
sc.addOption("stand up", ["Stand", "Up", "Get"], "standing");
...
var scenes = [start, credits, sc, sc03i, end];
